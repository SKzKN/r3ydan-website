...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        // Simple validation
        if (!name || !email) {
            alert('Palun täitke kõik kohustuslikud väljad (märgitud tärniga)!');
            return;
        }
        ...
        setTimeout(() => {
            alert('Täname! Teie sõnum on edukalt saadetud. Võtame teiega 24 tunni jooksul ühendust tasuta konsultatsiooni broneerimiseks.');
            this.reset();
...
window.addEventListener('scroll', () => {
    ...
    const heroElements = document.querySelectorAll('.graphic-element');
...
console.log('%cREYDAN Website', 'color: #3498db; font-size: 20px; font-weight: bold;');
console.log('%cWebsite developed with modern web technologies', 'color: #7f8c8d; font-size: 12px;');
